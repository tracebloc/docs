---
title: "Bare-metal"
description: "Deploy the tracebloc client on your own on-prem Kubernetes cluster."
---

**When to pick it** — You already run Kubernetes on-prem (k3s, kubeadm, RKE, …) and want the client on it, with full control over scheduling and storage.

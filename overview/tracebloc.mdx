...
<CardGroup cols={2}>
  <Card title="Your infrastructure" icon="server">
    Runs on your Mac, Linux box, GPU server, or any Kubernetes cluster.
  </Card>

  <Card title="Your data" icon="lock">
    Stays inside your network. Contributors never see raw records.
  </Card>

  <Card title="Invite anyone" icon="user-plus">
    Whitelist contributors by email. They see EDA and metadata. Never raw data.
  </Card>

  <Card title="One leaderboard" icon="ranking-star">
    Every submission benchmarked under identical conditions. Ship the winner.
  </Card>

  <Card title="Compliance by architecture" icon="shield-check">
    Data never moves. Sign off once on the architecture, not once per partner.
  </Card>
</CardGroup>

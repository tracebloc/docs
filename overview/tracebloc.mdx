---
title: "tracebloc"
description: "Build AI with anyone. On data that can't move. Build better AI together. Without moving data."
---
...
```shellscript Mac / Linux lines wrap
bash <(curl -fsSL https://tracebloc.io/install.sh)
```

```powershell Windows lines wrap

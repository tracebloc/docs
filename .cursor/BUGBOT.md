# Bugbot guide — tracebloc/docs

## Context

Mintlify product documentation, published at docs.tracebloc.io. Pages are `.mdx`
with `docs.json` for navigation; some pages are synced from other repos
(`.github/sync-sources.yml`) and must be edited at their source. Public repo.

...
Choose a model from the [tracebloc model zoo](https://github.com/tracebloc/model-zoo) or define your own architecture. For details on model formats, mandatory variables, parameter matching, and pre-trained weights, see [Customize Models](/join-use-case/model-optimization).

Upload the model to the use case workspace:

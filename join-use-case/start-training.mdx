...
1. Select the best performing training cycle during which you want to evaluate the performance on the test dataset and submit the model. Hover over the learning cureves and read the best performing validation training cycle, then enter it below in the field "Submit for inference at c".

...
The SDK requires Python 3.11 or 3.12. On an older Python, `pip` cannot see any
current release and silently falls back to 0.8.1, which is eight releases behind.

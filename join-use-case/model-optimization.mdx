...
This section explains the model format required to upload and train models on the tracebloc workspace.
...
The file must contain these variables:
* **framework** : name of the framework for which this model file is created. For Sklearn its value will be pytorch.
...
Some variables are necessary specific to a category

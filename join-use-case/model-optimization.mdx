...
This section covers model code formats, mandatory variables per framework, and pre-trained weights. For a quick-start guide with parameter matching and an example, see [Start Training](/join-use-case/start-training#2-upload-model--customize).

...
|-----------------------|----------------|-----------------------------------|---------------------------------------------------------------------------------------------------------|----------|
| Classification        | TXT            | CSV                               |      Text file may not be empty  | [Detailed structure](#text-classification) <br></br>[Example](https://github.com/tracebloc/data-ingestors/tree/develop/templates/text_classification) |

---
title: "Define and Create AI Use Case on Tracebloc"
description: "Step-by-step guide to creating and defining AI use cases on Tracebloc. Learn how to set up privacy, configure datasets, invite participants, and publish your model evaluation project."
---
...
- Task: Select the task, e.g. "Image Classification", "Image Detection", "Tabular Classification", etc. In case your use case is not yet supported, please reach out to us at [support@tracebloc.io](mailto:support@tracebloc.io).

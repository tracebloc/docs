...
<Warning>
**Validation error like `'<your_category>' is not one of [...]` or `Additional properties are not allowed`?** Your local Helm chart cache is stale and doesn't know about the newer category or schema field. Refresh it before retrying:
